    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if(document.referrer !== ''){
            ...
            if (window.location.hostname == referrer.hostname) {
                text = '欢迎来到<span style="color:#0099cc;">『雨宿り的个人博客』</span>';
...
// function loadModel(){
    ...
    //     console.log('https://api.fghrsh.net/live2d/get/?id='+modelId+'-'+modelTexturesId)
    // console.log(modelTexturesId==0)
...
function bug() {
    // loadlive2d('live2d','http://127.0.0.1:3002/pio/model2.json')
...
//     $.ajax({
//             cache: false,
//             url: 'https://cdn.jsdelivr.net/gh/1059431281/CDN/live2d/pio/model.json',
//             dataType: "json",
//             type:"get",
//             data:{
