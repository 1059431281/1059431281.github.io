...
!function (e, t) {
    ...
    return function (e) {
        ...
        n(30);
        var i = n(43), a = r(i), s = n(27), l = r(s), c = n(26), u = r(c), d = n(47), p = r(d), f = document,
            h = navigator, v = /[&<>"'`\\]/g, g = RegExp(v.source), m = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g,
            y = RegExp(m.source),
            b = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "`": "&#x60;", "\\": "&#x5c;"},
            w = {};
        ...
        Array.prototype.forEach || (Array.prototype.forEach = function (e, t) {
            ...
            prepend: function (e) {
                ...
                return this.forEach(function (t) {
                    var n = void 0, r = 0, o = e && e.match(/[^\x20\t\r\n\f\*\/\\]+/g);
        ...
        (0, a.default)(l.default, {
            ...
            dynamicLoadSource: function (e, t) {
                if ((0, l.default)('script[src="' + e + '"]').length) "function" == typeof t && t(); else {
                    var n = f.createElement("script");
                    n.src = e, n.async = !0, n.setAttribute("referrerPolicy", "no-referrer");
                    (0, l.default)("head")[0].appendChild(n), n.onload = n.onreadystatechange = function () {
                        var e = this;
                        e.onload = e.onreadystatechange = null, (0, l.default)(n).remove(), "function" == typeof t && t()
                    }
                }
            },
            sdkLoader: function (e, t, n) {
                t in window ? (k && clearTimeout(k), n && n()) : l.default.dynamicLoadSource(e, function () {
        ...
        var i, a, s = function () {
                ...
                return e.__proto__
            }, d = i ? u(i) : void 0, p = a ? u(a) : void 0, f = a ? a() : void 0,
            h = "undefined" == typeof Uint8Array ? void 0 : u(Uint8Array), v = {
                "%Array%": Array,
            ...
            }, g = n(3), m = g.call(Function.call, String.prototype.replace),
            y = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
            b = /\\(\\)?/g, w = function (e) {
                var t = [];
        ...
        "use strict";
        t.__esModule = !0;
        t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.DEFAULT_CONFIG = {
            lang: "zh-CN",
            langMode: null,
            appId: "",
            appKey: "",
        ...
        "use strict";
        var r = n(45), o = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"),
            i = Object.prototype.toString, a = Array.prototype.concat, s = Object.defineProperty, l = function (e) {
        ...
        "use strict";
        var r = n(3), o = n(1), i = o("%Function%"), a = i.apply, s = i.call;
        e.exports = function () {
        ...
        "use strict";
        var r = n(32), o = n(31), i = n(33), a = i("String.prototype.replace"),
        ...
        var x = n(2).FilterCSS, k = n(2).getDefaultWhiteList, _ = n(4), A = new x, S = /</g, O = />/g, $ = /"/g,
            E = /&quot;/g, j = /&#([a-zA-Z0-9]*);?/gim, T = /&colon;?/gim, P = /&newline;?/gim,
            C = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            I = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, M = /u\s*r\s*l\s*\(.*/gi, z = /<!--[\s\S]*?-->/g;
        ...
        function i(e, t, n) {
            "user strict";
            var i = "", a = 0, s = !1, l = !1, c = 0, u = e.length, d = "", p = "";
            for (c = 0; c < u; c++) {
                var f = e.charAt(c);
                if (!1 === s) {
                    if ("<" === f) {
...
*/
        ...
        var a = n(25), s = r(a), l = n(17), c = r(l), u = n(21), d = r(u), p = n(20), f = r(p), h = n(5), v = n(24),
            g = r(v), m = n(6), y = r(m), b = n(0), w = r(b), x = n(23), k = r(x), _ = n(19), A = r(_), S = n(22),
            O = r(S), $ = {comment: "", nick: "Anonymous", mail: "", link: "", ua: w.default.ua, url: ""}, E = "", j = {
        ...
        o.prototype.init = function (e) {
            ...
            var t = this;
            return e = w.default.extend(h.DEFAULT_CONFIG, e), (0, A.default)(e, function (n) {
                t.i18n = (0, d.default)(e.lang || w.default.lang, e.langMode), t.config = e, e.emojiCDN && e.emojiMaps && (f.default.maps = e.emojiMaps, f.default.cdn = e.emojiCDN), !!e && t._init()
            }), t
        }, o.prototype._init = function () {
            var e = this;
            try {
                var t = e.config, n = t.avatar, r = t.avatarForce, o = t.avatar_cdn, i = t.visitor, a = t.path,
                    s = void 0 === a ? location.pathname : a, l = t.pageSize, c = t.recordIP;
                e.config.path = s.replace(/index\.html?$/, "");
                var u = j.ds, d = r ? "&q=" + Math.random().toString(32).substring(2) : "";
                j.params = "?d=" + (u.indexOf(n) > -1 ? n : "mp") + "&v=1.4.5" + d, j.hide = "hide" === n, j.cdn = /^https?\:\/\//.test(o) ? o : j.cdn, e.config.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, c && (w.default.sdkLoader("//api.ip.sb/jsonip?callback=getIP", "getIP"), window.getIP = function (e) {
                    $.ip = e.ip
                });
                var p = (0, w.default)(".valine-comment-count"), f = 0;
                !function t(n) {
                    var r = n[f++];
                    if (r) {
                        var o = (0, w.default)(r).attr("data-xid");
        ...
        var P = function (e, t) {
            ...
            r.setPublicReadAccess(!0), r.setPublicWriteAccess(!0), n.setACL(r), n.set("url", t.url), n.set("xid", t.xid), n.set("title", t.title), n.set("time", 1), n.save().then(function (e) {
                (0, w.default)(t.el).find(".leancloud-visitors-count").text(1)
            }).catch(function (e) {
            })
        }, C = {
            add: function (e, t) {
                var n = this, r = (0, w.default)(".leancloud_visitors,.leancloud-visitors");
                if (1 === r.length) {
                    var o = r[0], i = decodeURI((0, w.default)(o).attr("id")),
                        a = (0, w.default)(o).attr("data-flag-title"), s = encodeURI(i),
                        ...
                        c.equalTo("url", i), c.find().then(function (t) {
                            if (t.length > 0) {
                                ...
                                n.increment("time"), n.save().then(function (e) {
                                    (0, w.default)(o).find(".leancloud-visitors-count").text(e.get("time"))
                                }).catch(function (e) {
                                })
                            } else P(e, l)
                        }).catch(function (t) {
                ...
                if (t.forEach(function (e) {
                    var t = (0, w.default)(e).find(".leancloud-visitors-count");
                    t && t.text(0), n.push(decodeURI((0, w.default)(e).attr("id")))
                }), n.length) {
                    var r = new AV.Query(e);
                    r.containedIn("url", n), r.find().then(function (e) {
                        e.length > 0 && e.forEach(function (e) {
                            var t = e.get("url"), n = e.get("time");
                            (0, w.default)(".leancloud_visitors,.leancloud-visitors").forEach(function (e) {
                                var r = (0, w.default)(e);
        ...
        o.prototype.Q = function (e) {
            var t = this, n = arguments.length, r = t.config.clazzName;
            if (1 == n) {
            ...
            if (n.$el && n.$loading.hide().nodata.hide(), "[object Error]" === {}.toString.call(e)) {
                var r = e.code || "";
                if (r) {
                    var o = n.i18n.t("code-" + r), i = (o == "code-" + r ? void 0 : o) || e.message || e.error || "";
            ...
            var e = this, t = e.$el.find(".vemojis"), n = e.$el.find(".vpreview"), r = e.$el.find(".vemoji-btn"),
                o = e.$el.find(".vpreview-btn"), i = e.$el.find(".veditor"), a = f.default.maps, l = !1,
                u = function (e) {
                    var n = [];
                    for (var r in a) a.hasOwnProperty(r) && n.push('<i title="' + r + '" >' + f.default.build(r) + "</i>");
                    t.html(n.join("")), l = !0, t.find("i").on("click", function (e) {
                        e.preventDefault(), b(i[0], " :" + (0, w.default)(this).attr("title") + ":")
                    })
                };
            e.$emoji = {
                show: function () {
                ...
                show: function () {
                    return E ? (e.$emoji.hide(), o.addClass("actived"), n.html(E).show(), C()) : e.$preview.hide(), e.$preview
                }, hide: function () {
                    return o.removeClass("actived"), n.hide().html(""), e.$preview
                }
            };
            var d = function (e) {
                E = (0, k.default)(f.default.parse(e.val() || "")), o.hasClass("actived") > -1 && E != n.html() && n.html(E), (0, c.default)(e[0]), C()
            };
            ...
            var p = e.config.meta, h = {}, v = {veditor: "comment"};
            p.forEach(function (e) {
                v["v" + e] = e
            });
            for (var m in v) v.hasOwnProperty(m) && function () {
                var t = v[m], n = e.$el.find("." + m);
                h[t] = n, n.on("input change blur propertychange", function (e) {
                    "blur" === e.type && "nick" === t && setTimeout(function (e) {
                        !isNaN(n.val()) && (0, O.default)(n.val(), function (e) {
                            var t = e.name || n.val();
                            (0, w.default)(".vnick").val(t), (0, w.default)(".vmail").val(e.qq + "@qq.com"), $.nick = t, $.mail = e.qq + "@qq.com", $.QQAvatar = e.pic
                        })
                    }, 200), "comment" === t ? d(n) : $[t] = w.default.escape(n.val().replace(/(^\s*)|(\s*$)/g, "")).substring(0, 40)
                })
            }();
            var b = function (e, t) {
                ...
                (0, c.default)(e)
            }, x = {no: 1, size: e.config.pageSize, skip: e.config.pageSize}, _ = e.$el.find(".vpage");
            _.on("click", function (e) {
                _.hide(), x.no++, A()
            });
            var A = function () {
                var t = x.size, n = x.no, r = Number(e.$el.find(".vnum").text());
                e.$loading.show();
                ...
                o.limit(t), o.skip((n - 1) * t), o.find().then(function (o) {
                    if (x.skip = x.size, o && o.length) {
                        ...
                        o.forEach(function (t) {
                            i.push(t.id), S(t, e.$el.find(".vcards"), !0)
                        }), e.Q(e.config.path, i).then(function (e) {
                            (e && e.results || []).forEach(function (e) {
                                S(e, (0, w.default)('.vquote[data-self-id="' + e.get("rid") + '"]'))
                            }).catch(function (e) {
                            })
                        }), t * n < r ? _.show() : _.hide()
                    } else e.$nodata.show();
            ...
            e.Q(e.config.path).count().then(function (t) {
                t > 0 ? (e.$el.find(".vcount").show().find(".vnum").text(t), A()) : e.$loading.hide()
            }).catch(function (t) {
                e.ErrorHandler(t, "count")
            });
            var S = function (t, n, r) {
                var o = (0, w.default)('<div class="vcard" id="' + t.id + '"></div>'), i = t.get("ua"), a = "";
                i && !/ja/.test(e.config.lang) && (i = w.default.detect(i), a = '<span class="vsys">' + i.browser + " " + i.version + '</span> <span class="vsys">' + i.os + " " + i.osVersion + "</span>"), "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    ...
                    // u = j.hide ? "" : t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (j.cdn + (0, s.default)(t.get("mail")) + j.params) + '">',
                    u = '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>'
                ...
                o.find("a").forEach(function (e) {
                    e && !(0, w.default)(e).hasClass("at") && (0, w.default)(e).attr({
                        target: "_blank",
                        rel: "nofollow"
                    })
                ...
                t.on("click", function (r) {
                    var o = t.attr("data-vm-id"), i = t.attr("data-self-id"), a = e.$el.find(".vwrap"),
                        s = "@" + w.default.escape(n.get("nick"));
                    (0, w.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), T = {
                ...
                setTimeout(function () {
                    try {
                        "MathJax" in window && "version" in window.MathJax && (/^3.*/.test(window.MathJax.version) && MathJax.typeset() || MathJax.Hub.Queue(["Typeset", MathJax.Hub, document.querySelector(".v")])), "renderMathInElement" in window && renderMathInElement((0, w.default)(".v")[0], {
                            delimiters: [{
                                left: "$$",
                                right: "$$",
                                display: !0
                            }, {left: "$", right: "$", display: !1}]
                        }), "hljs" in window && (0, w.default)("pre code,code.hljs").forEach(function (e) {
            ...
            !function (t) {
                if (t = w.default.store.get("_v_Cache") || t) for (var n in p) {
                    var r = p[n];
                    e.$el.find(".v" + r).val(w.default.unescape(t[r])), $[r] = t[r]
                }
            }(), e.reset = function () {
                $.comment = "", h.comment.val(""), d(h.comment), h.comment.attr("placeholder", e.config.placeholder), T = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), E = ""
            };
            var M = e.$el.find(".vsubmit"), z = function (t) {
                if ("" == E) return void h.comment[0].focus();
                $.comment = E, $.nick = $.nick || "Anonymous";
                ...
                w.default.store.set("vlx", Date.now()), M.attr({disabled: !0}), e.$loading.show(!0);
                var t = AV.Object.extend(e.config.clazzName || "Comment"), n = new t;
                if ($.url = decodeURI(e.config.path), $.insertedAt = new Date, T.rid) {
                    var r = T.pid || T.rid;
                    n.set("rid", T.rid), n.set("pid", r), $.comment = E.replace("<p>", '<p><a class="at" href="#' + r + '">' + T.at + "</a> , ")
                }
                for (var o in $) if ($.hasOwnProperty(o)) {
                    var i = $[o];
                    n.set(o, i)
                }
                n.setACL(L()), n.save().then(function (t) {
                    ...
                    try {
                        T.rid ? S(t, (0, w.default)('.vquote[data-self-id="' + T.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), S(t, e.$el.find(".vcards")), x.skip++), M.removeAttr("disabled"), e.$loading.hide(), e.reset()
                    } catch (t) {
            ...
            M.on("click", z), (0, w.default)(document).on("keydown", function (e) {
                e = event || e;
            ...
            var F = function (e, t) {
                ...
                if (o > 0) {
                    ...
                    b(i[0], s), B(a, function (l, u) {
                        !l && u ? (i.val(i.val().replace(s, "![" + a.name + "](" + u.data.url + ")\r\n")), (0, c.default)(i[0]), ++r < o ? t(n, r) : M.removeAttr("disabled")) : l && (i.val(i.val().replace(s, "")), (0, c.default)(i[0]), e.$el.find(".status-bar").text(l).empty(3e3), M.removeAttr("disabled"))
                    })
                }
            }, B = function (e, t) {
                var n = new FormData;
        ...
        t.__esModule = !0;
        var r = n(5), o = {
            cdn: r.DEFAULT_EMOJI_CDN, maps: n(53), parse: function (e) {
        ...
        t.__esModule = !0;
        var o = n(42), i = r(o), a = n(56), s = r(a), l = n(57), c = r(l), u = n(54), d = r(u), p = n(55), f = r(p),
            h = {
                zh: s.default,
                "zh-cn": s.default,
                "zh-CN": s.default,
        ...
        t.default = function (e, t) {
            ...
            if (n) t && t(n); else {
                ...
                o.default.sdkLoader(i, r), window[r] = function (n) {
                    window[r] = null, n.qq = e, n.pic = "https://q2.qlogo.cn/headimg_dl?dst_uin=" + e + "&spec=100", o.default.store.set("v_" + e, n), t && t(n)
                }
            }
        }
    }, function (e, t, n) {
        ...
        t.__esModule = !0;
        var o = n(41), i = r(o), a = n(6), s = r(a), l = n(0), c = r(l), u = n(36), d = new o.Renderer;
        d.code = function (e, t) {
            ...
            renderer: "hljs" in window ? d : new o.Renderer, highlight: function (e, t) {
                return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : u(e)
            }, gfm: !0, tables: !0, breaks: !0, pedantic: !1, sanitize: !1, smartLists: !0, smartypants: !0
        }), t.default = function (e) {
        ...
        var r = function (e, t) {
            if (!e) return "";
            try {
                var n = i(e).getTime(), r = (new Date).getTime(), a = r - n, s = Math.floor(a / 864e5);
                if (0 === s) {
                    var l = a % 864e5, c = Math.floor(l / 36e5);
                    if (0 === c) {
                        var u = l % 36e5, d = Math.floor(u / 6e4);
                        if (0 === d) {
                            var p = u % 6e4;
            ...
            var t = a(e.getDate(), 2), n = a(e.getMonth() + 1, 2);
        ...
        "use strict";
        var r = n(1), o = r("%String%"), i = r("%TypeError%");
        e.exports = function (e) {
        ...
        "use strict";
        var r = n(1), o = n(10), i = o(r("String.prototype.indexOf"));
        e.exports = function (e, t) {
            var n = r(e, !!t);
        ...
        "use strict";
        var r = n(40), o = Object.prototype.toString, i = Object.prototype.hasOwnProperty, a = function (e, t, n) {
        ...
        !function (t, n) {
            ...
            return function (r, o) {
                ...
                var a = 0, s = {},
                    l = /[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/,
                    c = /</, u = new RegExp("(" + l.source + "|" + c.source + ")|(" + t().source + ")", "gmi");
        ...
        }, s = Object.prototype.toString, l = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag;
        e.exports = function (e) {
            if (!e) return !1;
        ...
        (function (t) {
            !function (t) {
                ...
                v._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, v._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, v.def = c(v.def).replace("label", v._label).replace("title", v._title).getRegex(), v.bullet = /(?:[*+-]|\d+\.)/, v.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, v.item = c(v.item, "gm").replace(/bull/g, v.bullet).getRegex(), v.list = c(v.list).replace(/bull/g, v.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + v.def.source + ")").getRegex(), v._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", v._comment = /<!--(?!-?>)[\s\S]*?-->/, v.html = c(v.html, "i").replace("comment", v._comment).replace("tag", v._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), v.paragraph = c(v.paragraph).replace("hr", v.hr).replace("heading", v.heading).replace("lheading", v.lheading).replace("tag", v._tag).getRegex(), v.blockquote = c(v.blockquote).replace("paragraph", v.paragraph).getRegex(), v.normal = p({}, v), v.gfm = p({}, v.normal, {
                    ...
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e;) if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({type: "space"})), o = this.rules.code.exec(e)) e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                        type: "code",
        ...
        function l(e, t, n, r, o) {
            ...
            if (null == t) return e;
            var a = e, s = r || w, l = o || b, c = "number" == typeof t ? {smart_count: t} : t;
        ...
        var u = n(34), d = n(50), p = n(39), f = n(48), h = function (e) {
            d(!1, e)
        }, v = String.prototype.replace, g = String.prototype.split, m = "||||", y = function (e) {
            var t = e % 100, n = t % 10;
            ...
            pluralTypes: {
                ...
                }, bosnian_serbian: y, chinese: function () {
                    return 0
                }, croatian: y, french: function (e) {
                    return e > 1 ? 1 : 0
                }, german: function (e) {
                    return 1 !== e ? 1 : 0
                }, russian: y, lithuanian: function (e) {
...
*/
        ...
        var r;
        if (!Object.keys) {
            var o = Object.prototype.hasOwnProperty, i = Object.prototype.toString, a = n(11),
                s = Object.prototype.propertyIsEnumerable, l = !s.call({toString: null}, "toString"),
                c = s.call(function () {
                }, "prototype"),
            ...
            r = function (e) {
                var t = null !== e && "object" == typeof e, n = "[object Function]" === i.call(e), r = a(e),
                    s = t && "[object String]" === i.call(e), d = [];
                if (!t && !n && !r) throw new TypeError("Object.keys called on a non-object");
                var p = c && n;
                if (s && e.length > 0 && !o.call(e, 0)) for (var f = 0; f < e.length; ++f) d.push(String(f));
                if (r && e.length > 0) for (var v = 0; v < e.length; ++v) d.push(String(v)); else for (var g in e) p && "prototype" === g || !o.call(e, g) || d.push(String(g));
        ...
        "use strict";
        var r = Array.prototype.slice, o = n(11), i = Object.keys, a = i ? function (e) {
            return i(e)
        } : n(44), s = Object.keys;
        a.shim = function () {
            if (Object.keys) {
 ...
 */
        ...
        "use strict";
        var r = n(10), o = n(9), i = n(12), a = n(13), s = n(49), l = r(a());
        ...
        var s = n(2).FilterCSS, l = n(15), c = n(16), u = c.parseTag, d = c.parseAttr, p = n(4);
        a.prototype.process = function (e) {
            if (e = e || "", !(e = e.toString())) return "";
            var t = this, n = t.options, i = n.whiteList, a = n.onTag, s = n.onIgnoreTag, c = n.onTagAttr,
                f = n.onIgnoreTagAttr, h = n.safeAttrValue, v = n.escapeHtml, g = t.cssFilter;
            ...
            var y = u(e, function (e, t, n, l, u) {
                var m = {sourcePosition: e, position: t, isClosing: u, isWhite: i.hasOwnProperty(n)}, y = a(n, l, m);
                if (!r(y)) return y;
                if (m.isWhite) {
                    if (m.isClosing) return "</" + n + ">";
                    var b = o(l), w = i[n], x = d(b.html, function (e, t) {
        ...
        function o(e, t) {
            for (var n = [], r = {}, o = 0; o < e.length; o++) {
                var i = e[o], a = t.base ? i[0] + t.base : i[0], s = i[1], l = i[2], c = i[3],
