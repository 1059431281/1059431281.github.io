...
function bot_ui_ini() {
    ...
    var sure = function () {
        ...
        secondpart = function () {
            botui.message.add({
                delay: 1500,
                content: "现在还是一名半计算机专业的大学生"
            }).then(function () {
                botui.message.add({
                    delay: 1500,
                    content: "热爱动漫、音乐、阅读，励志被富美少女包养（一切努力的目标）"
                }).then(function () {
                    botui.message.add({
                        delay: 1500,
                        content: "曾经梦想成为漫画家，却阴差阳错掉入计算机的深渊"
                    }).then(function () {
                        botui.message.add({
                            delay: 1200,
                            content: "因此现在的梦想有：画师、小说家、网站设计师（全都要！）"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "目前而言，这些梦想已经完成一半，剩下的难题打算再慢慢攻破"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1500,
                                    content: "没关系我并不着急，正所谓一急就输了嘛"
                                }).then(function () {
                                    botui.message.add({
                                        delay: 1800,
                                        content: "还有最重要的一点，我永远喜欢雪之下雪乃！"
                                    }).then(function () {
                                        botui.action.button({
                                            delay: 1100,
                                            action: [{
        ...
        thirdpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "在构思类似的名字的时候，看见一条推荐语句就决定了"
            }).then(function () {
                botui.action.button({
                    delay: 1500,
                    action: [{
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "出自我曾经一本小说的男主名（才不是不想再买个域名）。"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
                    content: "那么最后再说一次，我永远喜欢雪之下雪乃！"
                })
            })
        }
}